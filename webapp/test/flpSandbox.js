					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP ESSENTIAL ONE",
									"targetURL": "#workbench-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"workbench-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workbench",
									"url": sap.ui.require.toUrl("workbench")
								}
							}
						}
					}
